...
const DayAvailabilityCard: React.FC<DayAvailabilityCardProps> = ({
  ...
  return (
    <View style={[styles.card, { backgroundColor: colors.WHITE_COLOR }]}> 
      <View style={styles.headerRow}>
        ...
        <TouchableOpacity style={[styles.addButton, { backgroundColor: colors.PRIMARY_COLOR }]} onPress={onAddSlot} activeOpacity={0.8}>
      ...
      <View style={styles.slotArea}>
        {slots.length ? (
          ...
          <View style={styles.emptyState}>
            <Text style={[styles.emptyText, { color: colors.SECONDARY_COLOR }]}>No availability set</Text>
            <Text style={[styles.emptyHint, { color: colors.GRAY_COLOR }]}>Tap + to add time slots</Text>
          </View>
        )}
      </View>
    </View>
