...
export const getOnboardingData = (colors: any) => [
  {
    ...
    description:
      'Connect instantly with expert tutors for personalized learning.',
  ...
  },
  {
    ...
    description:
      'Strengths and weaknesses, and get personalized study plans.',
  ...
  },
  {
    ...
    description:
      'Monitor learning progress, session history, and achievements.',
